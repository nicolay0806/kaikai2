export const curriculum = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: "u2-l5", title: "5. 資源管理員", description: "減法在生活情境中的應用", slides: [{type:"text", content:"應用題時間！\n把數學用在生活上。"}, {type:"interactive", task:"count_to_target", content:"計算庫存"}], quiz: [{question:"有 500 元，買了 100 元的東西，剩多少？", options:["300", "400", "600"], answer:1}] }
    ]
  },
  {
    id: 3,
    ...
    lessons: [
      ...
      { id: "u3-l2", title: "2. 節奏律動", description: "2、5、10 的乘法表與規律", slides: [{type:"text", content:"九九乘法表是數學特務的必備口訣。\n\n二一得二\n二二得四..."}, {type:"interactive", task:"count_to_target", content:"跟上節奏"}], quiz: [{question:"5 x 3 = ?", options:["10", "15", "20"], answer:1}] },
      { id: "u3-l3", title: "3. 三三兩兩", description: "3、6、9 的乘法表與生活題", slides: [{type:"text", content:"3 的乘法表：\n3, 6, 9, 12...\n你發現規律了嗎？"}, {type:"interactive", task:"count_to_target", content:"計算中"}], quiz: [{question:"3 x 3 = ?", options:["6", "9", "12"], answer:1}] },
      { id: "u3-l4", title: "4. 高難度挑戰", description: "4、7、8 的乘法記憶", slides: [{type:"text", content:"這邊比較難背，多念幾次：\n\n七七四十九\n七八五十六！"}, {type:"interactive", task:"count_to_target", content:"突破極限"}], quiz: [{question:"7 x 2 = ?", options:["14", "12", "16"], answer:0}] },
      { id: "u3-l5", title: "5. 戰力加成", description: "乘法應用", slides: [{type:"text", content:"當數字變大時，\n乘法可以幫我們快速算出總數。"}, {type:"interactive", task:"count_to_target", content:"計算戰力"}], quiz: [{question:"10 x 5 = ?", options:["50", "15", "105"], answer:0}] }
    ]
  },
  {
    id: 4,
    ...
    lessons: [
      ...
      { id: "u4-l5", title: "5. 分配小劇場", description: "除法應用題", slides: [{type:"text", content:"生活應用題！\n確認你有沒有學會公平分配。"}, {type:"interactive", task:"count_to_target", content:"解決問題"}], quiz: [{question:"有 9 張貼紙，分給 3 人，每人幾張？", options:["2", "3", "4"], answer:1}] }
    ]
  },
  {
    id: 5,
    ...
    lessons: [
      ...
      { 
        ...
        slides: [
            { type: "text", content: "這是最後的戰役，特務！\n整合你學會的一切！", image: "https://images.unsplash.com/photo-1535905557558-afc4877a26fc?auto=format&fit=crop&q=80&w=1000" },
